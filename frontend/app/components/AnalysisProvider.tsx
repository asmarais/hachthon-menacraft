...
export default function AnalysisProvider({ children }: { children: ReactNode }) {
  ...
  const analyze = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: "START_ANALYSIS", payload: "Preparing analysis…" });

      const progressMessages = [
        "Uploading & extracting features…",
        "Running forensic pipelines…",
        "Evaluating authenticity axes…",
        "Checking contextual consistency…",
